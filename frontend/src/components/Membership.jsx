export default function Membership() {
  return (
    <div className="bg-gray-50">
      {/* HERO */}
      <section className="relative bg-[url('/farm.png')] bg-cover bg-center h-[45vh] flex items-center">
        ...
        <div className="relative max-w-6xl mx-auto px-6 text-white">
          ...
          <p className="max-w-2xl text-sm md:text-lg text-gray-200">
            Join Farm Bureau and gain access to valuable benefits, savings, and
            programs that support agriculture and rural communities.
          </p>
        </div>
      </section>
      ...
      <section className="bg-gray-50 min-h-[60vh] flex items-center justify-center py-16">
        <div className="w-full max-w-md mx-auto">
          <div
            className="relative bg-white rounded-2xl p-8 text-center shadow-xl border border-gray-100 
          ...
          >
            ...
            <p className="text-gray-600 text-sm leading-relaxed">
              Support agriculture and access exclusive discounts, benefits, and
              community programs designed to strengthen rural living.
            </p>
